...
public class User {
	...
	public String toString() {
		return "User [id=" + id + ", name=" + name + ", pwd=" + pwd + ", email=" + email + ", loginPwd2=" + loginPwd2
				...
				+ ", logintime=" + logintime + ", exittime=" + exittime + ", ip=" + ip + ", staytime=" + staytime + "]";
	}
	...
	public User(int id, String name, String pwd, String email,String logintime,String exittime, String ip, String staytime) {
		super();
		this.id = id;
		this.name = name;
		this.pwd = pwd;
